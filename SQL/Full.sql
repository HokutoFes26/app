...
INSERT INTO stalls_status (id, stall_name) VALUES (1, 'ポップコーン'), (2, 'イカ焼き・どんどん焼き'), (3, 'おにぎり・飲み物・アイスクレープ'), (4, '焼き鳥'), (5, 'たい焼き'), (6, 'たこ焼き'), (7, '焼きそば'), (8, 'チュロス'), (9, '揚げパン・フルーツ飴・ラムネ'), (10, '肉巻きおにぎり'), (11, 'どら焼き・お茶'), (12, '大判焼き'), (13, 'ペットボトル飲料'), (14, 'わたあめ'), (15, 'コーヒー・クレープ'), (16, 'フランクフルト'), (17, 'クロッフル'), (18, 'あんばやし'), (19, '唐揚げ'), (20, 'ベビーカステラ'), (21, 'めいどびより'), (22, '冥土カフェ'), (23, 'お茶会～2日目のみ～')
...
-- Vote Targets (Booths)
INSERT INTO vote_targets (id, name, category, display_order) VALUES ('01', 'ポップコーン', 's', 1), ('02', 'イカ焼き・どんどん焼き', 's', 2), ('03', 'おにぎり・飲み物・アイスクレープ', 's', 3), ('04', '焼き鳥', 's', 4), ('05', 'たい焼き', 's', 5), ('06', 'たこ焼き', 's', 6), ('07', '焼きそば', 's', 7), ('08', 'チュロス', 's', 8), ('09', '揚げパン・フルーツ飴・ラムネ', 's', 9), ('10', '肉巻きおにぎり', 's', 10), ('11', 'どら焼き・お茶', 's', 11), ('12', '大判焼き', 's', 12), ('13', 'ペットボトル飲料', 's', 13), ('14', 'わたあめ', 's', 14), ('15', 'コーヒー・クレープ', 's', 15), ('16', 'フランクフルト', 's', 16), ('17', 'クロッフル', 's', 17), ('18', 'あんばやし', 's', 18), ('19', '唐揚げ', 's', 19), ('20', 'ベビーカステラ', 's', 20), ('21', 'めいどびより', 's', 21), ('22', '冥土カフェ', 's', 22), ('23', 'お茶会～2日目のみ～', 's', 23)
...
INSERT INTO vote_targets (id, name, category, display_order) VALUES ('31', '機械・電気・物質工学科展示', 'e', 1), ('32', '地域連携スタートアップ紹介', 'e', 2), ('33', '入試相談コーナー', 'e', 3), ('34', '校長スペース', 'e', 4), ('35', '書道作品展示', 'e', 5), ('36', '部誌・読書スペース', 'e', 6), ('37', '写真展示', 'e', 7), ('38', 'ゲーム・イラスト展示', 'e', 8), ('39', 'VS電子', 'e', 9), ('40', '恋みくじ・フォトスポット', 'e', 10), ('41', 'VS S2 キッキングスナイパー！', 'e', 11), ('42', '電子情報工学科展示', 'e', 12), ('43', '縁日 (I3)', 'e', 13), ('44', '縁日 (K3)', 'e', 14), ('45', 'お化け屋敷', 'e', 15), ('46', '若潮丸展示', 'e', 16), ('47', 'フォトスポット', 'e', 17), ('48', '写真展', 'e', 18), ('49', '専攻科紹介', 'e', 19), ('50', '新聞の展示', 'e', 20), ('51', '国際ビジネス学科展示', 'e', 21), ('52', '国際教育センター展示', 'e', 22), ('53', '商船航海コース展示', 'e', 23), ('54', 'ロボット操縦体験', 'e', 24), ('55', 'ジオラマ展示', 'e', 25), ('56', 'ロボット展示', 'e', 26), ('57', '商船機関コース展示', 'e', 27)
ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, category = EXCLUDED.category, display_order = EXCLUDED.display_order;
